                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Welcome to My Portfolio Web".tr,
                                    style: TextStyle(
                                      color: global.isDarkMode.value == true
                                          ? textDark
                                          : primaryCrimson,
                                  ...
                                  Expanded(
                                    child: Text(
                                      "You can look around the skill I have \nAnd the projects I've developed on this Web;".tr,
                                      style: TextStyle(
                                        color: global.isDarkMode.value == true
                                            ? textDark
                                            : primaryCrimson,
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          "I started learning Flutter to make my own apps,\nBut now I'm trying to make apps that can be used by \nMany people with more diverse skills;".tr,
                                          style: TextStyle(
                                            color: global.isDarkMode.value == true
                                                ? onPrimaryDark
                                                : onPrimary,
