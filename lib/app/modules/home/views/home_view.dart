          ...
          return Obx(
            () => Scaffold(
              backgroundColor: global.isDarkMode.value == true
                  ? backgroundDark
                  : backgroundLight,
              appBar: mediaQueryWidth < 700 == true ||
                  ...
                  ? AppBar(
                      actions: [
                        Obx(
                          () => IconButton(
                            onPressed: () {
                              if (global.isDarkMode.value == true) {
                                global.lightModeOn();
                              } else if (global.isDarkMode.value == false) {
                                global.darkModeOn();
                              } else {}
                            },
                            icon: Icon(
                  ...
                  : null,
              bottomNavigationBar: mediaQueryWidth < 700 == true ||
                      mediaQueryHeight < 600 == true
                  ? Obx(
                      () => BottomNavigationBar(
                        onTap: (i) {
                        ...
                        items: [
                          ...
                          BottomNavigationBarItem(
                              icon: Icon(Icons.book_rounded), label: 'Career'),
                        ],
                      ),
                    )
                  : null,
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          color: controller.portfolioFocused.value == true
                                                                              ? primaryCrimson
                                                                              : containerDark,
                                                                          borderRadius:
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          color: controller.projectFocused.value == true
                                                                              ? primaryCrimson
                                                                              : containerDark,
                                                                          borderRadius:
                                                                              BorderRadius.circular(25),
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration:
                                                                            BoxDecoration(
                                                                          color: controller.blogFocused.value == true
                                                                              ? primaryCrimson
                                                                              : containerDark,
                                                                          borderRadius:
                                                                              BorderRadius.circular(25),
