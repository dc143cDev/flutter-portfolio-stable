...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    double mediaQueryWidth = MediaQuery
        .of(context)
        .size
        .width;
    double mediaQueryHeight = MediaQuery
        .of(context)
        .size
        .height;
    ...
    return Scaffold(
      ...
      appBar: mediaQueryWidth < 700 == true || mediaQueryHeight < 600 == true
          ? AppBar()
          : null,
            ...
            BottomNavigationBar(
              ...
              items: [
                BottomNavigationBarItem(
                    icon: Icon(Icons.portrait_rounded), label: 'Who am I'),
                BottomNavigationBarItem(
